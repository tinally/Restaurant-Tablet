...
public class DatabaseTest {
  ...
  /*
  @Test
  public void testSimpleDatabaseTest() throws SQLException {
    ConnectionSource connection = new JdbcConnectionSource("jdbc:sqlite::memory:");
    Dao<IngredientImpl, String> ingredientDao =
        DaoManager.createDao(connection, IngredientImpl.class);
    TableUtils.createTable(connection, IngredientImpl.class);
    ...
    ingredientDao.createOrUpdate(ingredientTwo);

    Ingredient retrieved = ingredientDao.queryForId("Test Ingredient");
    Ingredient retrievedTwo = ingredientDao.queryForId("Test Ingredient Two");
